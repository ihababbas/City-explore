...
class Formloc extends React.Component{
    ...
    handleChange = (e) => {
      ...
      handleSubmit = async (e) => {
        ...
        const weatherData = await axios.get(`http://localhost:3001/weather?lon=${cityInfo.lon}&lat=${cityInfo.lat}`)
      const movieData = await axios.get(`http://localhost:3001/movie?city=${this.state.city}`)
